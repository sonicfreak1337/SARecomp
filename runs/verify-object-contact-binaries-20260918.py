...
paths=[Path('build-linux/game'),Path('out/object-contact-linux-20260918/game'),Path('out/model-submission-windows-20260918/game.exe')]
def sections(path):
...
Path('runs/object-contact-executables-20260918.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r,indent=2));assert r['allocated_sections_identical']
