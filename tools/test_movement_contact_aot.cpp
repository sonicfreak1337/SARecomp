...
void load_original_entries(const std::filesystem::path& root){
    ...
    for(const auto* name:{"native-port-dispatch-shard-101379.cpp","native-port-dispatch-shard-202755.cpp","native-port-dispatch-shard-202756.cpp","native-port-dispatch-shard-202757.cpp","native-port-dispatch-shard-202762.cpp","native-port-dispatch-shard-202766.cpp","native-port-dispatch-shard-202767.cpp","native-port-dispatch-shard-202785.cpp","native-port-dispatch-shard-202951.cpp","native-port-dispatch-shard-202952.cpp","native-port-dispatch-shard-202953.cpp"}){
