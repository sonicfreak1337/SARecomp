...
option(SARECOMP_LINUX_RAM_PREPARED_ACCESS "Private function-local RAM capability qualification" OFF)
...
if(SARECOMP_LINUX_RAM_PREPARED_ACCESS AND NOT SARECOMP_LINUX_RAM_REGIONS)
...
if(SARECOMP_LINUX_SCALAR_WRITES OR SARECOMP_LINUX_STACK_FRAMES OR SARECOMP_LINUX_RAM_REGIONS)
    ...
    if(SARECOMP_LINUX_RAM_PREPARED_ACCESS)
        list(APPEND scalar_probe_args --region-prepared-access)
    endif()
    if(SARECOMP_LINUX_RAM_REGIONS_EXTENDED)
