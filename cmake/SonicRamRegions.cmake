...
option(SARECOMP_WINDOWS_RAM_PREPARED_ACCESS "Private function-local RAM capability qualification" OFF)
if(SARECOMP_WINDOWS_RAM_PREPARED_ACCESS AND SARECOMP_WINDOWS_RAM_REGIONS STREQUAL "OFF")
    message(FATAL_ERROR "Prepared access qualification requires RAM regions")
endif()
...
if(NOT SARECOMP_WINDOWS_RAM_REGIONS STREQUAL "OFF")
    ...
    if(SARECOMP_WINDOWS_RAM_PREPARED_ACCESS)
        list(APPEND sonic_windows_ram_args --region-prepared-access)
    endif()
