...
if(SARECOMP_NATIVE_ANIMATION_BRIDGE)
    ...
    if(TARGET sonic_linux_guest)
        ...
        if(TARGET sonic_ram_regions)
            if(NOT animation_unit IN_LIST sonic_windows_ram_units)
                message(FATAL_ERROR "Native animation member missing from prepared RAM owners")
            endif()
            set(animation_input "${sonic_windows_ram_dir}/${animation_unit}")
            target_sources(sonic_ram_regions PRIVATE "${animation_bridge}")
        else()
